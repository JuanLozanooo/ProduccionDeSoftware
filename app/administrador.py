...
class Administrador:
    ...
    async def crear_usuario(self, session: AsyncSession, datos: Dict[str, Any]) -> Usuario:
        query = text(
            "INSERT INTO usuario (id_usuario, rol, username, email_usuario, password, activo) "
    ...
    async def consultar_usuario(self, session: AsyncSession, id_usuario: int) -> Optional[Usuario]:
        query = text("SELECT id_usuario, rol, username, email_usuario, password, activo FROM usuario WHERE id_usuario = :id")
    ...
    async def crear_libro(self, session: AsyncSession, datos: Dict[str, Any]) -> Libro:
        query = text(
            "INSERT INTO libro (id_libro, titulo, autor, categoria, anio_publicacion) "
